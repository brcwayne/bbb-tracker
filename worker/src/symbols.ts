...
export type PriceSource = 'yahoo' | 'altin-turev' | 'tefas' | 'tradingview'

/**
 * Yahoo chart symbol for an instrument, or null when another source handles it
 * (`tefas` → fonoloji, `tradingview` → scanner) or P3 does not price it.
 */
